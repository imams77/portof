...
class ProductBoxListView extends Component {
       ...
       let RatingStars = [];
        ...
        return (
            <div className="col mb-45">
                <div className="product-wrap product-wrap--grid-view">
                        ...
                        <Link to={process.env.PUBLIC_URL+'/product-simple-one/'+productData.id}>
                            {
                                ...
                                <img className="default-img" src={`${process.env.PUBLIC_URL}${
                                    this.state.image ? 
                                    this.state.image : productData.colorVariations[0].image
                                }`} alt="" />
                                :
                                <div>
                    ...
                    <div className="product-content text-center">
                        ...
                        </div>
                        {
                            ...
                            <div className="product-colo-wrap">
                                <ul>
                                {
                ...
                {/* product list view */}
                <div className="product-wrap product-wrap--list-view">
                        ...
                        <div className="row">
                            <div className="col-lg-4 col-md-4 col-sm-5">
                                <div className="product-img-list">
                                    ...
                                    <div className="product-quickview-list">
                                        <button title="Quick Shop" onClick={this.handleShow}>Quick Shop</button>
                                    </div>
                                    ...
                                    <div className="product-details-content quickview-content">
                                        ...
                                        <div className="pro-details-quality">
                                            <div className="pro-details-cart btn-hover">
                                                {
                                                    ...
                                                    <button title="Add To Cart" onClick={() => addToCart(productData, this.state.quantity)}>Add to cart</button>
                                                    : 
                                                    <button className="disabled" title="Out of Stock">Out of Stock</button>
                                                }
                                            </div>
                                            ...
                                            <div className="pro-details-compare">
                                                <button title="Add To Compare" onClick={() => addToCompare(productData)}><i className="negan-icon-switch" /> <span>Add To Compare</span></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="row">
                                    <div className="col-xl-5 col-md-6 col-sm-12 col-xs-12">
                                        <div className="quickview-img-wrap">
                                            <Slider 
                                            className="quickview-big-img-slider text-center"
                                            {...quickviewLargeImageSliderSettings}
                                            asNavFor={this.props.nav1}
...
export default connect(null,{addToCart, addToWishlist, addToCompare})(ProductBoxListView)