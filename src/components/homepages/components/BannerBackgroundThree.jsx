...
function BannerBackgroundThree() {
    return (
        <div className="row">
            <div className="percentage-col-40 percentage-col-common">
                <div className="single-banner-4 mb-10">
                <Link to={process.env.PUBLIC_URL+'/shop-sidebar'}><img alt='' src={process.env.PUBLIC_URL + '/img/banner/banner-11.jpg'} /></Link>
            ...
            <div className="percentage-col-20 percentage-col-common">
                <div className="single-banner-4 mb-10">
            ...
            <div className="percentage-col-20 percentage-responsive percentage-col-common">
                <div className="single-banner-4 mb-10">
            ...
            <div className="percentage-col-60 percentage-col-common">
            ...
            <div className="percentage-col-40 percentage-responsive-2 percentage-col-common">
...
export default BannerBackgroundThree
