...
function SliderThree() {
    ...
    let heroSliderData = [
        {image: '/img/slider/m-5-slide-1.jpg', titleOne: 'Spring Fresh', titleTwo: '#TRENDING 2019', url: '/shop-sidebar', contentPosition: 'left', contentColor: '', contentAlign:''}, 
        {image: '/img/slider/m-5-slide-2.jpg', titleOne: 'Sale off 70%', titleTwo: 'FLASH SALE - LIMITED TIME OFFER', url: '/shop-sidebar', contentPosition: 'left', contentColor: '', contentAlign:''},
