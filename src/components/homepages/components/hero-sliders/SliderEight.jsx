...
function SliderEight() {

    let heroSliderData = [
        {image: '/img/slider/m-12-slide-1.jpg', titleOne: 'New', titleTwo: 'ARRIVAL', subtitle: 'FREE SHIPPING ORDER OVER $100', url: '/shop-sidebar', contentPosition: 'left'}, 
