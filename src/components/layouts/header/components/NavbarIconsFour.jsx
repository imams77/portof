...
class NavbarIconsFour extends Component {
            ...
            <div className="header-right-wrap">
                <div className="same-style account-satting d-block">
                    ...
                    <ul className="d-none d-lg-block">
                        ...
                        <li><Link to={process.env.PUBLIC_URL + '/login-register'}>Login / Register</Link></li>
                ...
                <div className="same-style header-off-canvas d-none d-lg-block">
                    <button className="header-aside-button" onClick={this.triggerMenuAside}><i className="negan-icon-menu-left" /></button>
                </div>
...
export default connect(mapStateToProps)(NavbarIconsFour)
